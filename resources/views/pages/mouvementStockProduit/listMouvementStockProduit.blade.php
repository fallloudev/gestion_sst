...
@section('titre')
    <span>Mouvements de stock produit</span>
@endsection
            ...
            <div class="card table-card">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        ...
                        <a href="{{ route('mouvementStockProduit.add') }}" class="btn btn-primary">
                            Ajouter
                        </a>
                    </div>
                </div>
                ...
                <div class="card-body p-3">
                    ...
                    <form method="GET" class="row g-3 mb-3 align-items-end">
                        ...
                        <div class="col-md-3 d-flex gap-2">
                            ...
                            <a href="{{ route('mouvementStockProduit.list') }}" class="btn btn-outline-secondary">
                                Réinitialiser
                            </a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($mouvement->reference === \App\Constant::REF['NO_REF'])
                                                <form action="{{ route('mouvementStockProduit.delete', $mouvement->id) }}"
