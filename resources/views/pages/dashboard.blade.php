...
<div class="row">
        ...
        <div class="card">
            <div class="card-body d-flex align-items-center">
                <div class="flex-grow-1 me-3">
                    <p class="mb-1 text-muted">Clients</p>
                    <h4>{{ $clients }}</h4>
                </div>
    ...
    <div class="col-xxl-3 col-md-6">
        <div class="card">
            <div class="card-body d-flex align-items-center">
                <div class="flex-grow-1 me-3">
                    <p class="mb-1 text-muted">Commandes</p>
                    <h4>{{ $commandes }}</h4>
                </div>
                <div class="avtar avtar-l bg-light-info rounded-circle">
                    <i class="ph-duotone ph-shopping-cart f-28"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xxl-3 col-md-6">
        <div class="card">
            <div class="card-body d-flex align-items-center">
                <div class="flex-grow-1 me-3">
                    <p class="mb-1 text-muted">Chiffre d’affaires</p>
                    <h4>{{ number_format($ca, 0, ',', ' ') }} FCFA</h4>
                </div>
    ...
    {{-- <div class="col-xxl-3 col-md-6">
        <div class="card">
            <div class="card-body d-flex align-items-center">
                <div class="flex-grow-1 me-3">
                    <p class="mb-1 text-muted">Stocks critiques</p>
                    <h4>{{ $stocksCritiques }}</h4>
                </div>
                <div class="avtar avtar-l bg-light-danger rounded-circle">
                    <i class="ph-duotone ph-warning f-28"></i>
                </div>
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item px-0 py-2">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="../assets/images/user/avatar-6.jpg" alt="img"
                                    class="wid-40 rounded-circle">
                            </div>
                            <div class="flex-grow-1 mx-3">
                                <h6 class="mb-1">Colleen join Addicted membership</h6>
...
<div class="row">
    <div class="col-md-3">
        <div class="card"><div class="card-body">
            <p class="text-muted">Matières premières</p>
            <h4>{{ $mpCount }}</h4>
        </div></div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card"><div class="card-body">
            <p class="text-muted">Stocks MP critiques</p>
            <h4 class="text-danger">{{ $stockMpCritique }}</h4>
        </div></div>
    </div>

    <div class="col-md-3">
        <div class="card"><div class="card-body">
            <p class="text-muted">Ordres en cours</p>
            <h4>{{ $ordreEnCours }}</h4>
        </div></div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card"><div class="card-body">
            <p class="text-muted">Production du jour</p>
            <h4>{{ $productionJour }}</h4>
        </div></div>
    </div>
</div>
@endif
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card"><div class="card-body">
            <p class="text-muted">Factures en attente</p>
            <h4 class="text-warning">{{ $facturesAttente }}</h4>
        </div></div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card"><div class="card-body">
            ...
            <h4>{{ number_format($caJour, 0, ',', ' ') }} FCFA</h4>
        </div></div>
    </div>
</div>
@endif
