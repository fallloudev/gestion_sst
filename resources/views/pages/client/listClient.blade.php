                    ...
                    <form method="GET" class="row g-2 mb-3">
                        <div class="col-md-4">
                            <input type="text" name="search" class="form-control"
                                placeholder="Rechercher par nom, type ou téléphone..." value="{{ request('search') }}">
                        </div>
                        <div class="col-md-2">
                            ...
                            <tbody>
                                @forelse($clients as $client)
                                    <tr>
                                        ...
                                        {{-- Actions --}}
                                        <td class="text-end">
                                            @if (Auth::user()->role->libelle === \App\Constant::ROLES['ADMIN'] ||
                                                    Auth::user()->role->libelle === \App\Constant::ROLES['ROOT'] ||
